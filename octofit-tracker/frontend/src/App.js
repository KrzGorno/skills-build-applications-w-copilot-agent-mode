...
function App() {
  // Aktywna ścieżka do podświetlania linków
    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4 text-center"><h2 className="display-5 mb-3">Witamy w Octofit Tracker!</h2><p className="lead">Monitoruj swoje aktywności, rywalizuj w rankingach i zarządzaj zespołami!</p></div>} />
        </Routes>
      </div>
    </Router>
  );
